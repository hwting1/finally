...
<required_reading>
Read `/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
