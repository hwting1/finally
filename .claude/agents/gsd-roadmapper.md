...
Reference full template: `/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/templates/state.md`.
