...
```
Agent(
  prompt="Read /home/hwting/File/self_learning/Udemy/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/templates/SECURITY.md`
