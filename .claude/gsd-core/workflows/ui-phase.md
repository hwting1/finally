...
```markdown
Read /home/hwting/File/self_learning/Udemy/finally/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/hwting/File/self_learning/Udemy/finally/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/hwting/File/self_learning/Udemy/finally/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/hwting/File/self_learning/Udemy/finally/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
