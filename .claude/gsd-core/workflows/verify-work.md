...
<template>
@/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/workflows/diagnose-issues.md
