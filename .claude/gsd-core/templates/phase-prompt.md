...
<!-- For checkpoint task examples and patterns, see @/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/hwting/File/self_learning/Udemy/finally/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
