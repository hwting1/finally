...
**Verification depth scales with `asvs_level`** (see @/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
