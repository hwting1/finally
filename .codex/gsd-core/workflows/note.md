...
- **Global scope**: `/home/hwting/File/self_learning/Udemy/finally/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/hwting/File/self_learning/Udemy/finally/.codex/notes/`)
...
2. Glob `/home/hwting/File/self_learning/Udemy/finally/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/hwting/File/self_learning/Udemy/finally/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/hwting/File/self_learning/Udemy/finally/.codex/notes/` — works in any directory
