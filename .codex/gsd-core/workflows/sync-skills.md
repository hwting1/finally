...
INSTALL_JS_GLOBAL="/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
