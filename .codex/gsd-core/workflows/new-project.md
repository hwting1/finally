...
Set the instruction file variable via the shared runtime-name policy adapter (`node "$HOME/.codex/gsd-core/bin/gsd-tools.cjs" query project-instruction-file`, backed by `getProjectInstructionFile` in `runtime-name-policy.cjs` — the single source of truth shared with `profile-output.cjs`):
```bash
...
Use template: /home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: /home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: /home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/research-project/PITFALLS.md
</output>
...
Use template: /home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/research-project/SUMMARY.md
