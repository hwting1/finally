...
ones). Reference: @/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/hwting/File/self_learning/Udemy/finally/.codex.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/hwting/File/self_learning/Udemy/finally/.codex/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/spec.md.
