...
<required_reading>
@/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/user-story-template.md
@/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/spidr-splitting.md
@/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/references/spidr-splitting.md`. Briefly:
