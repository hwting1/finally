...
MILESTONE_ARG=$(echo "{{GSD_ARGS}}" | sed -E 's/--ws[[:space:]]+[^[:space:]]+//g' | xargs)
...
Use template: /home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/research-project/{FILE}
</output>
