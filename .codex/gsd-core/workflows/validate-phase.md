...
```
Agent(
  prompt="Read /home/hwting/File/self_learning/Udemy/finally/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/VALIDATION.md`
