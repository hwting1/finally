...
```
Agent(
  prompt="Read /home/hwting/File/self_learning/Udemy/finally/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/templates/SECURITY.md`
