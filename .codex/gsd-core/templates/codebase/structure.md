...
- Usage: Reference from command with `@/home/hwting/File/self_learning/Udemy/finally/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/hwting/File/self_learning/Udemy/finally/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/hwting/File/self_learning/Udemy/finally/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
